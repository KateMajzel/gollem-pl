...
if master_process:
    if init_from == 'scratch' and os.path.exists(os.path.join(out_dir, 'ckpt.pt')):
...
while True:
    ...
    dt = t1 - t0
    t0 = t1
    # crash-safe: zapis co 250 iteracji NIEZALEZNIE od val loss
    ...
    if iter_num % log_interval == 0 and master_process:
        ...
        gb_seen = iter_num * tokens_per_iter * bytes_per_token / 1e9
